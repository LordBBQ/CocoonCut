...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_4_DESC "Go to zero XY"
  #define MAIN_MENU_ITEM_4_GCODE "G1 X0 Y0 F500"
  #define MAIN_MENU_ITEM_4_CONFIRM

  #define MAIN_MENU_ITEM_5_DESC "Go to zero Z"
  #define MAIN_MENU_ITEM_5_GCODE "G1 Z0 F500"
